    ...
    [
      {
        ...
        'watch': false,
        'tsconfig': `${ resolve( __dirname, './typedoc_tsconfig.json' ) }`,
        'externalPattern': [
          '**/node_modules/**',
          '**/simulation_servers/**'
        ],
        ...
        'name': 'UniversalTools.esm.mts的API文档',
        'options': `${ resolve( __dirname, './src/tools/ts/universal_tools/type_doc/typedoc.json' ) }`,
        'json': `${ resolve( __dirname, './src/tools/ts/universal_tools/type_doc/doc/UniversalTools.doc.json' ) }`,
        'entryPoints': [
          `${ resolve( __dirname, './src/tools/ts/universal_tools/UniversalTools.esm.mts' ) }`
        ],
        'out': `${ resolve( __dirname, './src/tools/ts/universal_tools/type_doc/doc' ) }`,
        'readme': `${ resolve( __dirname, './src/tools/ts/universal_tools/type_doc/README.md' ) }`
      },
      `${ resolve( __dirname, './src/tools/ts/universal_tools/UniversalTools.esm.mts' ) }`,
    ],
  ],
