...
module.exports = {
  resolve: {
    ...
    alias: {
      ...
      'deno_x_corejs$': 'https://deno.land/x/corejs@v3.49.0/index.js',
      ...
      'MF_v2_RegisterRemotes$': path.resolve( __dirname, './src/ModuleFederation_v2_RegisterRemotes.se.esm.mts' ),
    },
    /**
