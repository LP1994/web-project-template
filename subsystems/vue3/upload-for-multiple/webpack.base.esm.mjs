...
const aliasConfig = {
  ...
  assetsWebpackPluginConfig = {
    filename: 'webpack_assets_manifest_UploadForMultiple.json',
    ...
    metadata: {
      display: 'webpack_assets_manifest_UploadForMultiple',
      version: '8.0.0',
      date: ( () => {
        const {
          year,
  ...
  cleanWebpackPluginConfig = {
    ...
    cleanOnceBeforeBuildPatterns: [
      '**/*',
      '!webpack_assets_manifest_UploadForMultiple.js',
      '!webpack_assets_manifest_UploadForMultiple.json',
      '!webpack_assets_manifest_UploadForMultiple.json5',
    ],
    /**
...
\n` );
  ...
  moduleFederationPluginConfig = {
     ...
     */
    name: 'Webpack5_MF2_RemoteEntry_UploadForMultiple',
    /**
     ...
     */
    filename: 'Webpack5_MF2_RemoteEntry_UploadForMultiple.js',
    /**
     ...
     */
    exposes: {
      './UploadForMultipleComponent': './src/components/UploadForMultiple.Vue3.ts.vue',
    },
    runtime: 'EntryRuntime_Webpack5_MF2_RemoteEntry_UploadForMultiple',
    shared: {
      vue: {
        /**
    ...
    manifest: {
      /**
       * 作为“output.path”目录内的相对路径。一般不用设置，默认就直接输出在“output.path”下，跟“webpack_assets_manifest_UploadForMultiple.json”同级目录。<br />
       * 1、如果设置了，那请求路径形如：<br />
       ...
       */
      fileName: 'Webpack5_MF2_RemoteEntry_UploadForMultiple-manifest.json',
