 ...
 * FileDirPath: simulation_servers/deno/src/servers/WebSocketServerForPort9900.mts
 * Author: 12278
...
${ ( error as Error ).message }`,
  ...
  },
  {
    ...
    /**
     * 用postman测试时：<br />
     * 1、当设置为'localhost'时，用如“https://localhost:9900”能连接上（http、https、ws、wss皆是如此）。<br />
     * 2、当设置为'127.0.0.1'时，用如“https://127.0.0.1:9900”、“https://localhost:9900”能连接上（http、https、ws、wss皆是如此）。<br />
     * 3、当设置为'0.0.0.0'时，用如“https://localhost:9900”、“https://127.0.0.1:9900”、“https://192.168.10.101:9900”能连接上（http、https、ws、wss皆是如此）。<br />
     *
     * 用浏览器测试时：<br />
     * 1、当设置为'localhost'时，用如“https://localhost:9900”能连接上（http、https、ws、wss皆是如此）。<br />
     * 2、当设置为'127.0.0.1'时，用如“https://127.0.0.1:9900”、“https://localhost:9900”能连接上（http、https、ws、wss皆是如此）。<br />
