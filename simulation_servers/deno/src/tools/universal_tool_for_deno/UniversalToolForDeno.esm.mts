 ...
 * deno run -A --watch --config=./deno.json --lock-write --check --v8-flags=--max-old-space-size=1024000 --reload ./src/App.mts --color=16m
 ...
 * deno run -A --watch --config=./deno.json --lock-write --check --v8-flags=--max-old-space-size=1024000 --reload ./src/App.mts --color=16m <br />
