 ...
 * FileDirPath: simulation_servers/deno/src/tools/universal_tool_for_deno/unit_test/Main.test.mjs
 * Author: 12278
...
/**
 * UniversalToolForDeno.esm.mjs的单元测试。
 */
...
import {
  ...
  MyConsole,
} from '../UniversalToolForDeno.esm.mjs';
