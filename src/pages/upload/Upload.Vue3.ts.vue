...
<template>
  ...
  <main class = 'css-reset full-screen overflow-hidden-auto'>
    ...
    <article class = 'css-reset upload-for-binary upload'>
...
const RemoteUploadForSingleComponent: T_VueComponent = defineAsyncComponent<T_VueComponent>( (): Promise<T_LoadRemoteVueComponent> => MF_v2_RuntimeAPI_LoadRemote<T_LoadRemoteVueComponent>( 'Remote_Vue_UploadForSingle/UploadForSingle' ) as Promise<T_LoadRemoteVueComponent> );

const RemoteUploadForMultipleComponent: T_VueComponent = defineAsyncComponent<T_VueComponent>( (): Promise<T_LoadRemoteVueComponent> => MF_v2_RuntimeAPI_LoadRemote<T_LoadRemoteVueComponent>( 'RemoteUploadForMultiple/UploadForMultiple' ) as Promise<T_LoadRemoteVueComponent> );
