 ...
 * FileDirPath: src/custom_declare_types/provide/underscore.d.ts
 * Author: 12278
...
namespace _ {
  ...
  type PropertyTypeOrAny<T, K> = K extends keyof T
                                 ? T[K]
                                 : any;
  ...
  type ListItemOrSelf<T> = T extends List<infer TItem>
                           ? TItem
                           : T;
  ...
  interface Underscore<T, V = T[]> {
     ...
     */
    zip(): V extends List<infer A>
           ? Array<[ A ]>
           : []; // eslint-disable-line @definitelytyped/no-single-element-tuple-type
  ...
  interface _Chain<T, V = T[]> {
    ...
    zip(): V extends List<infer A>
           ? _Chain<[ A ]>
           : _Chain<never, []>; // eslint-disable-line @definitelytyped/no-single-element-tuple-type
 ...
 */
declare const underscore: _.UnderscoreStatic;
