 ...
 * FileDirPath: src/custom_declare_types/provide/UniversalTools.d.ts
 * Author: 12278
 ...
 */
declare function SingletonFactory<T>( func: () => T ): () => T_Singleton<T>;
 ...
 */
declare function SingletonFactoryByGlobal<T>( func: () => T ): () => T_SingletonByGlobal<T>;
 ...
 */
declare function StringToUint8Array( data: string ): Uint8Array;
 ...
 */
declare function DateFormatForObject( dateInstance?: Date ): T_DateFormatForObject;
 ...
 */
declare function GetDataType( arg: any ): string;
 ...
 */
declare function IsDisjointFrom( arrA?: Array<any>, arrB?: Array<any> ): boolean;
 ...
 */
declare function IsSubsetOf( arrA?: Array<any>, arrB?: Array<any> ): boolean;
 ...
 */
declare function IsSupersetOf( arrA?: Array<any>, arrB?: Array<any> ): boolean;
 ...
 */
declare function Difference( arrA?: Array<any>, arrB?: Array<any> ): Array<any>;
 ...
 */
declare function Intersection( arrA?: Array<any>, arrB?: Array<any> ): Array<any>;
 ...
 */
declare function SymmetricDifference( arrA?: Array<any>, arrB?: Array<any> ): Array<any>;
 ...
 */
declare function Union( arrA?: Array<any>, arrB?: Array<any> ): Array<any>;

type T_ArrayPromiseAny = Array<Promise<any>>;
type T_CurrentlyExecutingByGlobal = Record<string, T_ArrayPromiseAny>;
type T_RequestItem = [ string, () => Promise<any> ];
/**
 * 数组，其成员都是一个2元的元组。<br />
 ...
 */
type T_ArrayRequestItem = Array<T_RequestItem>;
/**
 ...
 */
type T_RequestConcurrentControllerByGlobal = {
 ...
 */
declare function RequestConcurrentControllerByGlobal( requestConcurrentQuantity?: number | undefined ): T_RequestConcurrentControllerByGlobal;
...
declare const UniversalTools: {
   ...
   * 返回的对象里还有一个“clear”函数（支持清除后的回调函数操作，详细见上面的泛型别名“T_SingletonByGlobal<T>”），用于清除并置空已经生成的期望的“全局模式”的单例对象。
   */
  SingletonFactoryByGlobal: typeof SingletonFactoryByGlobal;
  /**
   * 将“String”类型的数据转换成“Uint8Array”类型。
   *
   * @param {string} data “String”类型的数据，必需。
   ...
   * @returns {T_DateFormatForObject} year：年、month：月、date：日、hours：时、minutes：分、seconds：秒、day：周（当为周日的时候返回的是字符串“日”，其他星期则是数字的字符串化）。
   */
  DateFormatForObject: typeof DateFormatForObject;
  /**
   * 获取数据类型的字符串，如：'[object HTMLDocument]'、'[object HTMLDocument XXX]'。<br />
   * PS:<br />
   * 1、如果传入的是被Proxy代理过的对象，会报错！<br />
   ...
   * @returns {boolean} 数组A、数组B两者之间是否没有交集，true表示没有交集，反之表示有交集。
   */
  IsDisjointFrom: typeof IsDisjointFrom;
  /**
   * 数组B是否是数组A的子集，true表示是，反之表示不是。
   *
   * @param {Array<any>} arrA 数组A，默认值为空数组，可选。
   ...
   * requestConcurrentToolByGlobal：实际用于全局的请求并发控制器函数工具，详细见：T_RequestConcurrentControllerByGlobal。<br />
   */
  RequestConcurrentControllerByGlobal: typeof RequestConcurrentControllerByGlobal;
};
