...
const defaultData = {
  ...
  itemprop: {
    type: 'website',
    url: 'https://192.168.1.3:8100/dev_server/pages/HelloWorld.html',
    name: 'HelloWorld',
    description: 'This is a page for HelloWorld.',
    image: 'https://192.168.1.3:8100/dev_server/static/ico/uncompressed/ico_512_512.png',
  },
  appLinks: {
    web: {
      url: 'https://192.168.1.3:8100/dev_server/pages/HelloWorld.html',
  ...
  og: {
    ...
    locale: 'zh_CN',
    image: {
      url: 'https://192.168.1.3:8100/dev_server/static/ico/uncompressed/ico_512_512.png',
      secureURL: 'https://192.168.1.3:8100/dev_server/static/ico/uncompressed/ico_512_512.png',
      type: 'image/png',
      width: '512',
      height: '512',
  ...
  twitter: {
    ...
    site: 'https://192.168.1.3:8100/dev_server/pages/HelloWorld.html',
    url: 'https://192.168.1.3:8100/dev_server/pages/HelloWorld.html',
    title: 'HelloWorld',
    description: 'This is a page for HelloWorld.',
  ...
  const config = [
...

    {
      ...
      data: {
        ...
        itemprop: {
          type: 'website',
          url: 'https://192.168.1.3:8100/dev_server/pages/Upload.html',
          name: 'Upload',
          description: 'This is a page for Upload.',
          image: 'https://192.168.1.3:8100/dev_server/static/ico/uncompressed/ico_512_512.png',
        },
        ...
        twitter: {
          type: 'website',
          creator: '1227839175@qq.com',
          site: 'https://192.168.1.3:8100/dev_server/pages/Upload.html',
          url: 'https://192.168.1.3:8100/dev_server/pages/Upload.html',
          title: 'Upload',
          description: 'This is a page for Upload.',
          card: 'summary_large_image',
