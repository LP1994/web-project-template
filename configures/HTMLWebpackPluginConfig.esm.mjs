...
const defaultData = {
  ...
  itemprop: {
    type: 'website',
    url: 'https://192.168.10.101:8100/dev_server/pages/HelloWorld.html',
    name: 'HelloWorld',
    description: 'This is a page for HelloWorld.',
  ...
  twitter: {
    ...
    site: 'https://192.168.10.101:8100/dev_server/pages/HelloWorld.html',
    url: 'https://192.168.10.101:8100/dev_server/pages/HelloWorld.html',
    title: 'HelloWorld',
    description: 'This is a page for HelloWorld.',
 ...
 *
 * @param {boolean} isProduction 值为true时表示生产环境，反之开发环境，该值依赖CLI参数中的“--mode”参数值，必需。<br />
 *
 * @param {boolean} isSPA 是否将项目设置成单页面应用程序(SPA)，true表示单页面应用程序(SPA)，false表示多页面应用程序(MPA)，必需。<br />
 *
 * @param {object} HTMLMinifyConfig 压缩HTML的配置选项，必需。<br />
 *
