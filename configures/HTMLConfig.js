...
let SubresourceIntegrityPlugin = require( 'webpack-subresource-integrity' ),
    ...
    isPro_boo = ( () => process.argv[ process.argv.findIndex( ( c, i, a ) => c === '--mode' ) + 1 ] === 'production' )(),
    proN_str = ( () => {
        let str1 = ( () => process.argv[ process.argv.findIndex( ( c, i, a ) => c === '--config' ) + 1 ] )();
...
module.exports = [
    // 当前该插件的最新版本只能跟“html-webpack-plugin v4.5.0”配套使用，较新的“html-webpack-plugin”版本还不能使用！！！
